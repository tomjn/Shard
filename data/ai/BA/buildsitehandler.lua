...
function BuildSiteHandler:EchoDebugPlans(inStr)
...
function BuildSiteHandler:CheckForDuplicates(unitName)
	...
	self:EchoDebugPlans("looking for duplicate plan for " .. unitName)
	for i, plan in pairs(self.plans) do
	...
	self:EchoDebugPlans("looking for duplicate construction for " .. unitName)
...
function BuildSiteHandler:UnitBuilt(unit)
	...
	if done then
		self:EchoDebugPlans(done.behaviour.name .. " " .. done.behaviour.id ..  " completed " .. done.unitName .. " " .. unitID)
...
function BuildSiteHandler:NewPlan(unitName, position, behaviour, resurrect)
	if resurrect then
		self:EchoDebugPlans("new plan to resurrect " .. unitName .. " at " .. position.x .. ", " .. position.z)
	else
		self:EchoDebugPlans(behaviour.name .. " plans to build " .. unitName .. " at " .. position.x .. ", " .. position.z)
	end
