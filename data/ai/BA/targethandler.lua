...
local function PlotSquareDebug(x, z, size, color, label, filled)
	if DebugDrawEnabled then
		...
		self.ai.map:DrawRectangle(pos1, pos2, color, label, filled, 8)
	end
end
...
function TargetHandler:UpdateDebug()
	if DebugDrawEnabled then
		self.ai.map:EraseRectangle(nil, nil, nil, nil, true, 8)
		self.ai.map:EraseRectangle(nil, nil, nil, nil, false, 8)
		local maxThreat = 0
		local maxValue = 0
